...
function timeslots($duration, $cleanup, $start, $end){
    ...
    $cleanupInterval = new DateInterval("PT".$cleanup."H");
...
<html lang="en">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?php }else{ ?>
                        <button class="btn btn-success book" data_timeslot="<?php echo $ts; ?>"><?php echo $ts; ?></button>
                    <?php } ?>
  ...
  <div class="modal-dialog">
    ...
    <script>
        $(".book").click(function(){
            var timeslot = $(this).attr('data_timeslot');
            $("#slot").html(timeslot);
